...
params = {
    ...
    "SCORES_PATHNAME": f"/Users/stefanfeiler/PycharmProjects/autobet_placer_1/23/SmartBetter_DEV/data/scores.xlsx",
    "ODDS_PATHNAME": f"/Users/stefanfeiler/PycharmProjects/autobet_placer_1/23/SmartBetter_DEV/data/historical_odds.csv",
    "DAYS": 7
}
