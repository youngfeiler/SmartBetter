...
def store_in_dict(driver, params):
    ...
    try:
        ...
        params['NBA TEAMS'] = ["Phoenix Suns", "Charlotte Hornets", "Chicago Bulls", "Detroit Pistons"]
        ...
        for team in params["NBA TEAMS"]:
            try:
                ...
                teams = gp.find_elements(By.XPATH, ".//span[contains(@class, 'team-name')]")

                teams0 = teams[0].get_attribute("textContent")

                teams1 = teams[1].get_attribute("textContent")
